  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-indigo-700 to-violet-700">
        <div className="relative mx-auto max-w-7xl px-4 py-20 text-center text-white sm:px-6 md:py-28 lg:px-8">
          ...
          <h1 className="mb-6 text-4xl font-extrabold leading-tight md:text-6xl">
            Find Your Perfect Laptop<br />in Gulhaji Plaza
          </h1>
          ...
          <div className="mx-auto mt-16 grid max-w-3xl grid-cols-1 gap-6 sm:grid-cols-3">
            <div className="rounded-2xl bg-white/10 p-5 backdrop-blur">
              ...
              <div className="text-xs uppercase tracking-wide text-indigo-200">Laptops in catalog</div>
            </div>
            <div className="rounded-2xl bg-white/10 p-5 backdrop-blur">
              <div className="text-2xl font-extrabold">3</div>
              <div className="text-xs uppercase tracking-wide text-indigo-200">Verified vendors</div>
            </div>
            <div className="rounded-2xl bg-white/10 p-5 backdrop-blur">
              <div className="text-2xl font-extrabold">93%</div>
              <div className="text-xs uppercase tracking-wide text-indigo-200">AI Precision@3</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-14 max-w-2xl text-center">
            <h2 className="mb-3 text-3xl font-extrabold md:text-4xl">Why LaptopMarket</h2>
            <p className="text-gray-600">Everything you need to make a confident purchase decision.</p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
              <div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-indigo-100 text-2xl">✨</div>
              <h3 className="mb-2 text-lg font-bold">AI-Powered Matching</h3>
              <p className="text-sm leading-relaxed text-gray-600">
                Tell us your budget and needs. Our content-based engine ranks every laptop to fit you best.
              </p>
            </div>
            <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
              <div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-green-100 text-2xl">🔒</div>
              <h3 className="mb-2 text-lg font-bold">Real PKR Prices</h3>
              <p className="text-sm leading-relaxed text-gray-600">
                Transparent pricing from verified vendors in Gulhaji Plaza. No hidden costs, no guesswork.
              </p>
            </div>
            <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
              <div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-100 text-2xl">💬</div>
              <h3 className="mb-2 text-lg font-bold">Direct WhatsApp</h3>
              <p className="text-sm leading-relaxed text-gray-600">
                Chat with vendors instantly. Check stock and negotiate before you visit.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="featured" className="bg-gray-50 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-14 max-w-2xl text-center">
            <h2 className="mb-3 text-3xl font-extrabold md:text-4xl">Featured Laptops</h2>
            <p className="text-gray-600">
              A preview of our catalog. Sign in to see all laptops with personalized recommendations.
            </p>
          </div>
          ...
          {loading ? (
            ...
            <p className="text-center text-gray-500">No laptops available yet.</p>
          ) : (
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {featured.map((laptop) => {
      ...
      <section id="how" className="py-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-14 max-w-2xl text-center">
            <h2 className="mb-3 text-3xl font-extrabold md:text-4xl">How It Works</h2>
            <p className="text-gray-600">Three simple steps to your next laptop.</p>
          </div>

          <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
            <div className="text-center">
              <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-full bg-indigo-600 text-xl font-extrabold text-white shadow-lg">1</div>
              <h4 className="mb-2 text-lg font-bold">Tell us your needs</h4>
              <p className="text-sm text-gray-600">Pick a budget and usage type — takes 30 seconds.</p>
            </div>
            <div className="text-center">
              <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-full bg-indigo-600 text-xl font-extrabold text-white shadow-lg">2</div>
              <h4 className="mb-2 text-lg font-bold">Get ranked matches</h4>
              <p className="text-sm text-gray-600">Our AI ranks laptops against your exact preferences.</p>
            </div>
            <div className="text-center">
              <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-full bg-indigo-600 text-xl font-extrabold text-white shadow-lg">3</div>
              <h4 className="mb-2 text-lg font-bold">Contact the vendor</h4>
              <p className="text-sm text-gray-600">WhatsApp the shop directly to verify and buy.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="map" className="bg-gray-50 py-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-10 max-w-2xl text-center">
            <h2 className="mb-3 text-3xl font-extrabold md:text-4xl">Visit Gulhaji Plaza</h2>
            <p className="text-gray-600">
